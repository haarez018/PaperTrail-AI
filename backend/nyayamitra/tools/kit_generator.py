...
def generate_kit(case_file: CaseFile, plan: dict[str, Any]) -> dict:
    ...
    elements.append(Paragraph("NyayaMitra", styles["title"]))
    ...
    for proc in procedures:
        ...
        elements.append(
            Paragraph(
                f"[Form PDF generated separately — download from NyayaMitra app]",
                ParagraphStyle(
                    "note",
                    parent=styles["small"],
                    textColor=SAFFRON,
    ...
    elements.append(
        Paragraph(
            f"Generated by NyayaMitra • {today} • nyayamitra.app",
